...
//used only for spin-polarized calculation
{
	...
	fprintf(ofpp, "energy  s_spinup  s_spindown  s  p_spinup  p_spindown  p  d_spinup  d_spindown  d  t_spinup  t_spindown  t\n");
	for(i = 0; i < nrbands; i++)
	{
		...
		fprintf(ofpp, "%f  %f  %f  %f  %f  %f  %f  %f  %f  %f  %f  %f  %f\n", pdos[i].energy - efermi, pdos[i].s_spinup, pdos[i].s_spindown, pdos[i].s_spinup + pdos[i].s_spindown, p_spinup, p_spindown, p_spinup + p_spindown, d_spinup, d_spindown, d_spinup + d_spindown, t_spinup, t_spindown, t_spinup + t_spindown);
	}
